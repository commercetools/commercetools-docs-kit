...
exports.onPreBootstrap = ({ reporter }, themeOptions) => {
  ...
  // Create the proxy import file for the theme add-on packages
  const pluginOptions = { ...defaultOptions, ...themeOptions };
  let markdownComponents = `/* THIS IS AN AUTOGENERATED FILE, DO NOT EDIT DIRECTLY */\n`;
  pluginOptions.themeAddOns.forEach((themeName, index) => {
    markdownComponents += `
import * as components${index} from '${themeName}/markdown-components';
    `;
  });
  markdownComponents += `\n
export default {
${pluginOptions.themeAddOns
  ...
  reporter.info(
    `creating the @commercetools-docs/gatsby-theme-docs/overrides directory`
  );
