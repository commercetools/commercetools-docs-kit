...
- `<SideBySide>`: positions its second child block to the right of the first child on wide viewport sizes if wide layout is allowed (see theme option and frontmatter above).
