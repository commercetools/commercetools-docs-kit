...
export const Container = styled.div`
  border: 1px solid ${colors.light.syntaxHighlightAccent};
...
const Header = styled.div`
  ...
  border-bottom: 1px solid ${colors.light.syntaxHighlightAccent};
