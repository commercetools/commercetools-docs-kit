...
const SvgLordIconHeadset = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      <clipPath id="lord-icon-headset_svg__c">
        <path d="M0 0h500v500H0z" />
      </clipPath>
      <clipPath id="lord-icon-headset_svg__b">
        <path d="M0 0h500v500H0z" />
      </clipPath>
      <filter
        id="lord-icon-headset_svg__e"
        width="300%"
        height="300%"
        x="-100%"
        y="-100%"
      ...
      <mask id="lord-icon-headset_svg__d" mask-type="alpha">
        <use href="#lord-icon-headset_svg__a" />
      </mask>
      <g
        id="lord-icon-headset_svg__a"
        clipPath="url(#lord-icon-headset_svg__b)"
        style={{
          display: 'block',
        }}
      >
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={12}
            d="m396.261 308.283-24.475 71.99c-6.396 18.812-20.868 34.085-32.298 34.085h-20.71m-42.43 2.067v-4.133c0-5.304 4.301-9.605 9.605-9.605h23.22c5.304 0 9.605 4.301 9.605 9.605v4.133c0 5.304-4.301 9.605-9.605 9.605h-23.22c-5.304 0-9.605-4.301-9.605-9.605z"
          />
          <path
            fill="red"
            d="M276.348 416.425v-4.133c0-5.304 4.301-9.605 9.605-9.605h23.22c5.304 0 9.605 4.301 9.605 9.605v4.133c0 5.304-4.301 9.605-9.605 9.605h-23.22c-5.304 0-9.605-4.301-9.605-9.605z"
          />
        </g>
      </g>
    </defs>
    <g
      clipPath="url(#lord-icon-headset_svg__c)"
      mask="url(#lord-icon-headset_svg__d)"
      style={{
        display: 'block',
      }}
    >
      <g
        filter="url(#lord-icon-headset_svg__e)"
      ...
      >
        <path
          ...
          className="lord-icon-headset_svg__design"
        />
        <path
          fill="#068BDF"
