...
const SvgLordIconSuitcase = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <clipPath id="lord-icon-suitcase_svg__c">
        <path d="M0 0h500v500H0z" />
      </clipPath>
      <clipPath id="lord-icon-suitcase_svg__b">
        <path d="M0 0h500v500H0z" />
      </clipPath>
      <filter
        id="lord-icon-suitcase_svg__e"
        width="300%"
        height="300%"
        x="-100%"
        y="-100%"
      ...
      <mask id="lord-icon-suitcase_svg__d" mask-type="alpha">
        <use href="#lord-icon-suitcase_svg__a" />
      </mask>
      <g
        id="lord-icon-suitcase_svg__a"
        clipPath="url(#lord-icon-suitcase_svg__b)"
        style={{
          display: 'block',
        }}
      >
    ...
    <g
      clipPath="url(#lord-icon-suitcase_svg__c)"
      mask="url(#lord-icon-suitcase_svg__d)"
      style={{
        display: 'block',
      }}
    >
      <g
        filter="url(#lord-icon-suitcase_svg__e)"
      ...
      >
        <path
          ...
          className="lord-icon-suitcase_svg__design"
        />
        <path
          fill="#CA5EED"
...
export default SvgLordIconSuitcase;
