...
const SvgUnlocked = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      <clipPath id="unlocked_svg__c">
        <path d="M0 0h500v500H0z" />
      </clipPath>
      <clipPath id="unlocked_svg__b">
        <path d="M0 0h500v500H0z" />
      </clipPath>
      <filter
        id="unlocked_svg__e"
      ...
      <mask id="unlocked_svg__d" mask-type="alpha">
        <use href="#unlocked_svg__a" />
      </mask>
      <g
        id="unlocked_svg__a"
        clipPath="url(#unlocked_svg__b)"
        style={{
          display: 'block',
        }}
      >
    ...
    <g
      clipPath="url(#unlocked_svg__c)"
      mask="url(#unlocked_svg__d)"
      style={{
        display: 'block',
      }}
    >
      <g
        filter="url(#unlocked_svg__e)"
      ...
      >
        <path
          ...
          className="unlocked_svg__design"
        />
        <path
          fill="#CA5EED"
