...
const SvgLordIconPackage = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <clipPath id="lord-icon-package_svg__f">
        <path d="M0 0h500v500H0z" />
      </clipPath>
      <clipPath id="lord-icon-package_svg__d">
        <path d="M0 0h500v500H0z" />
      </clipPath>
      <filter
        id="lord-icon-package_svg__a"
        width="100%"
        height="100%"
        x="0%"
        y="0%"
      ...
      <mask id="lord-icon-package_svg__e" mask-type="alpha">
        <g filter="url(#lord-icon-package_svg__a)">
          <use href="#lord-icon-package_svg__b" />
        </g>
      </mask>
      <mask id="lord-icon-package_svg__g" mask-type="alpha">
        <use href="#lord-icon-package_svg__c" />
      </mask>
      <g
        id="lord-icon-package_svg__c"
        clipPath="url(#lord-icon-package_svg__d)"
        style={{
          display: 'block',
        }}
      >
    ...
    <g
      clipPath="url(#lord-icon-package_svg__f)"
      mask="url(#lord-icon-package_svg__g)"
      style={{
        display: 'block',
      }}
    >
      <g
        filter="url(#lord-icon-package_svg__h)"
      ...
      >
        <path
          ...
          className="lord-icon-package_svg__design"
        />
        <path
          fill="#068BDF"
...
export default SvgLordIconPackage;
