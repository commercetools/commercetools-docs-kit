...
const SvgLordIconMmDocument = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#lord-icon-mm-document_svg__a)"
    ...
    <defs>
      <linearGradient
        id="lord-icon-mm-document_svg__a"
        x1={24.07}
        x2={352.56}
        y1={78.2}
        y2={406.69}
...
export default SvgLordIconMmDocument;
