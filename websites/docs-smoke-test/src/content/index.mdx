...
import { PrimaryButton } from '@commercetools-docs/gatsby-theme-sso-ui-kit'
...
<div style="display:flex;">
  <PrimaryButton onClick={() => window.location.href = 'https://commercetools.eu.auth0.com/authorize?response_type=code&client_id=xLk8EDUCc8PKqCbrSJCnuahvn86nEn4z&redirect_uri=https://docskit-ga-learning-index.commercetools.vercel.app&scope=openid%20profile'}>
    <p>Signup to track your progress</p>
  </PrimaryButton>
