...
<div style="display:flex;">
  <PrimaryButton onClick={() => window.location.href = `https://auth.id.commercetools.com/authorize?response_type=code&client_id=xLk8EDUCc8PKqCbrSJCnuahvn86nEn4z&redirect_uri=${window.location.origin}&scope=openid%20profile`}>
