...
<div style="display:flex;">
  <PrimaryButton onClick={() => window.location.href = 'https://commercetools.eu.auth0.com/authorize?response_type=code&client_id=xLk8EDUCc8PKqCbrSJCnuahvn86nEn4z&redirect_uri=https://docs.commercetools.com&scope=openid%20profile'}>
