...
```md
[Link](/components/links/#last-heading)
```

| Link                                    | Type          | Expected outcome                                                     |
| --------------------------------------- | ------------- | -------------------------------------------------------------------- |
| [Link](/components/links/#last-heading) | `anchor-link` | It should jump to that position without visible scrolling or reload. |

### Link to another page on this site, but using an absolute URL

```md
[Link](https://docs.commercetools.com/docs-smoke-test/components/code-blocks/)
```

| Link                                                                           | Type            | Expected outcome                                                               |
| ------------------------------------------------------------------------------ | --------------- | ------------------------------------------------------------------------------ |
| [Link](https://docs.commercetools.com/docs-smoke-test/components/code-blocks/) | `internal-link` | It should render an absolute URL in dev mode and a relative path in prod mode. |

### Link to another page on this site using a full path

```md
[Link](/components/code-blocks/)
```

| Link                             | Type          | Expected outcome                                |
| -------------------------------- | ------------- | ----------------------------------------------- |
| [Link](/components/code-blocks/) | `gatsby-link` | It should be a Gatsby link, history navigation. |
