...
```md
[Link](https://docs.commercetools.com/docs-smoke-test/components/code-block/)
```

| Link                                                                          | Type            | Expected outcome                                                               |
| ----------------------------------------------------------------------------- | --------------- | ------------------------------------------------------------------------------ |
| [Link](https://docs.commercetools.com/docs-smoke-test/components/code-block/) | `internal-link` | It should render an absolute URL in dev mode and a relative path in prod mode. |
...
| Link                            | Type          | Expected outcome                                |
| ------------------------------- | ------------- | ----------------------------------------------- |
| [Link](/components/code-block/) | `gatsby-link` | It should be a Gatsby link, history navigation. |
