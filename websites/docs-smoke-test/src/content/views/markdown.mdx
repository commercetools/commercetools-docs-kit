...
`Healthy`
  ...
  <DescriptionDetails>The subscription is delivering messages as expected</DescriptionDetails>
  <DescriptionTerm>
...
as soon as new messages can be delivered successfully again.
  ...
  <DescriptionTerm>Something else</DescriptionTerm>
  <DescriptionDetails>Yet something else</DescriptionDetails>
</DescriptionList>
