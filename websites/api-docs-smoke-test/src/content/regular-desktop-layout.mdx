---
title: Regular Desktop Layout
description: Test components that can flow into two content columns when not allowed to
wideLayout: false
---

<Subtitle>

Tests the responsive behavior in "largeDesktop" responsive sizes. It has the `widelayout` frontmatter set to `true`.
