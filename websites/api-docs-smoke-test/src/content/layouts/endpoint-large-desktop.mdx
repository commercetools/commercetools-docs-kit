...
## An Endpoint with Simple Request Example
...
## An Endpoint with Object Request Example
...
## An Endpoint with Simple Request & Response Examples

<ApiEndpoint apiKey="test" resource="/{projectKey}/resource" method="GET" />

## An Endpoint with Object Request & Response Examples

<ApiEndpoint apiKey="test" resource="/{projectKey}/resource" method="POST" />

## An Endpoint with Object Request & Multiple Response Examples
