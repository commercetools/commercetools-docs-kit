...
The [following link](ctp:test:endpoint:/{projectKey}/resource/{id}:POST) should point to the `resource` API endpoint.
Type link: [CustomerGroup](ctp:api:type:CustomerGroup)
