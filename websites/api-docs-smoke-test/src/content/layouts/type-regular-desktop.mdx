---
title: API Type Regular Desktop Layout
...
Tests the responsive behavior in "largeDesktop" responsive sizes. It has the `widelayout` frontmatter set to `false`. It contains a child section navigation as well.
