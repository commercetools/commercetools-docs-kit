...
Tests the responsive behavior in "largeDesktop" responsive sizes. It has the `widelayout` frontmatter set to `true`, but would be wide nevertheless because the whole site is wide.
