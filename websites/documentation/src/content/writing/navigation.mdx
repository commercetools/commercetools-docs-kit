...
_Writers - On what basis are the top navigation entries decided?_
...
_Writers/Nikolaus - Is this about the side navigation defined in `packages/gatsby-theme-docs/src/data/top-side-menu.yaml`, or?_
