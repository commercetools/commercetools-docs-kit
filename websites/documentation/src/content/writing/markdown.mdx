...
[Here is the rendered page.](/writing/sample)
...
- Bold and italicized
  ...
  ```
  This is a _**bold and italicized**_ text.
  ```
...
_Writers - It's a bit tricky to represent sample syntax, as shown below._
