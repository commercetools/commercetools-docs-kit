...
When using JSX components, it's recommended to leave a **blank line** between the element tags and content.
This allows the content to be parsed as Markdown, so you can use Markdown syntax within the custom component tags.
...
- `<Anchor>`: use to insert a custom anchor on any part of the document such as lists, paragraphs, etc.
  ...
  For more information, see [Custom anchors](/writing/markdown#custom-anchors).
