...
- `setTimeToRead` (number)<Anchor name="set-time-to-read" />: use to set the reading time of a page. If defined, it replaces the automatically generated value from gatsby.
