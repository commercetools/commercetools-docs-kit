...
- `b2b` (boolean): use to indicate if <B2B /> should be displayed for an entire page.

  <Info>

  You can use <B2B /> in other places of a file apart from the frontmatter section. For more information, see [B2B section](/writing/sample#b2b-section).
