...
[Algolia docsearch](https://docsearch.algolia.com/) is the 3rd party service we use to index and search our documentation. It is a hosted search API that allows you to integrate typo-tolerant search into websites.
