...
- `aiAssistantTopbarButton` (_optional_): Defaults to false, a boolean telling if the ai assistant launch button should be displayed in the site topbar.
...
- `products` (_optional_, array of strings): Defines which products the website relates to. Available options are: [`Composable Commerce`, `Frontend`, `Checkout`, `Connect`].
