...
To reduce to the minimum the memory usage in case of local development, set a environment variable `LOW_MEM=true`. In this way the development server runs in uncached mode.
